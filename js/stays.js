(() => {
  ...
  const stays = [
    ...
    },
    {
      ...
      amenities: ['Fenced campsite','Free parking','Bedding provided','7 washrooms','Wi-Fi','Roofed dining and campfire areas','24×7 caretaker'],
      notes: ['Chicken BBQ ₹700/kg.', 'Day and night jeep safaris cost extra.', 'Activity pickup/drop may cost extra.'],
      media: album('Sholanest Vattavada', 'assets/Vattavada/Sholanest Vattavada/photos', ['01_aerial_property_layout.jpeg','02_swing_valley_view.jpeg','03_family_at_swing.jpeg','05_washroom.jpeg','06_mud_house_exterior.jpeg','07_tent_interior_beds.jpeg','08_dining_deck_view.jpeg','09_cottage_room_chess_corner.jpeg','10_walkway_viewpoint.jpeg','11_mudhouse_pathway.jpeg'], ['property_walkthrough_1.mp4','property_walkthrough_2.mp4','property_walkthrough_3.mp4','property_walkthrough_4.mp4','property_walkthrough_5.mp4','property_walkthrough_6.mp4','property_walkthrough_7.mp4','property_walkthrough_8.mp4'])
    }
  ];

  const contact = Object.freeze({
    whatsapp: '917907668133',
    phoneLabel: '+91 79076 68133',
    email: 'camplink2@gmail.com',
    instagram: 'camplink1',
    instagramUrl: 'https://www.instagram.com/camplink1/'
  });
  const supportUrl = message => `https://wa.me/${contact.whatsapp}?text=${encodeURIComponent(message)}`;
  const bookingUrl = stay => supportUrl(`Hi CampLink, I would like to check availability and the current package price for ${stay.name}, Vattavada.`);

  window.CampLink = { stays, contact, bookingUrl, supportUrl, getStay: slug => stays.find(stay => stay.slug === slug) };
})();
